...
public class ChatRVAdapter extends RecyclerView.Adapter {
    ...
    private ArrayList<ChatsModal> chatModalArraylist;
    private Context context;

    public ChatRVAdapter(ArrayList<ChatsModal> chatModalArraylist, Context context) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        ChatsModal chatsModal = chatModalArraylist.get(position);
